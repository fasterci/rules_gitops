...
def _host_repo_impl(rctx):
    ...
    rctx.file("BUILD.bazel", """# @generated by @rules_gitops//gitops/private:host_repo.bzl
...
""")
    ...
    rctx.file("defs.bzl", content = """# @generated by @rules_gitops//gitops/private:host_repo.bzl
